...
var grammar = {
    ...
    {"name": "P", "symbols": [{"literal":"("}, "main", {"literal":")"}], "postprocess": d => d[1]},
    ...
    {"name": "U", "symbols": [{"literal":"+"}, "_", "N"], "postprocess": d => d[2]},
    {"name": "U", "symbols": [{"literal":"-"}, "_", "N"], "postprocess": d => -1 * d[2]},
    {"name": "U", "symbols": [{"literal":"+"}, "_", {"literal":"("}, "main", {"literal":")"}], "postprocess": d => d[3]},
    {"name": "U", "symbols": [{"literal":"-"}, "_", {"literal":"("}, "main", {"literal":")"}], "postprocess": d => -1 * d[3]},
    ...
    {"name": "float", "symbols": ["int", {"literal":"."}, "int"], "postprocess": d => +(d[0] + d[1] + d[2])},
    {"name": "float", "symbols": ["int"], "postprocess": d => +d[0]},
