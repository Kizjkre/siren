...
<nav class="flex h-full items-center justify-around w-full">
  <div class="flex grow h-full hover:nav:bg-gray-100 hover:nav:border-b-blue-600 hover:nav:text-blue-600 items-center ml-2 nav:border-b nav:border-b-transparent nav:h-full nav:px-4 nav:py-2 nav:transition">
