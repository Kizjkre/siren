// @ts-nocheck
const process = (/** @type {string} */ name, /** @type {() => any} */ synth, /** @type {{ postMessage: (arg0: { name: any; parameters: any; }) => void; onmessage: (e: any) => void; }} */ port, /** @type {{ time: string | any[]; }} */ parameters) => {
